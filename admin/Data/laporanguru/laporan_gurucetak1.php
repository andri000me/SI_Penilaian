...
<?php $sql=mysql_query("select tb_guru.*, tb_kompetensikeahlian.* from tb_guru, tb_kompetensikeahlian where tb_guru.kompetensi_kode=tb_kompetensikeahlian.kompetensi_kode and tb_guru.guru_kode='".$_GET['ks']."'")or die (mysql_error()); while($tam=mysql_fetch_array($sql)){ ?>
          <tr>
