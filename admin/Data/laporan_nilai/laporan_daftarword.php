...
$h2=mysql_query("select * from tb_standarkompetensi where sk_kode='$skkode'"); $fg2=mysql_fetch_array($h2);
 ...
 header("Content-Type: application/force-download"); header("Cache-Control: no-cache, must-revalidate"); header("Expires: Sat, 26 Jul 2010 05:00:00 GMT"); header("content-disposition: attachment;filename=daftarnilai".$fg['nama_kelas']."".date('dmY').".doc");
  ...
  <tr>
    <td width="885" height="42"><div align="center" class="style3">
      <div align="center"><br>
        ...
        <table width="837" border="0" align="center" class="table table-bordered table-hover">
          <tr>
            <td width="156" bgcolor="#99CCFF"><strong>NISN</strong></td>
            <td width="214" bgcolor="#99CCFF"><strong>Nama </strong></td>
            <td width="345" bgcolor="#99CCFF"><strong>Nilai</strong></td>
            <td width="104" bgcolor="#99CCFF"><strong>Grade</strong></td>
          </tr>
