...
<div class="well">
 ...
 <div class="table-header">
		  <a class="brand" href='?page=laporkelasnilai'>Data Kelas</a>
...
$kode2=$data['kode_kelas'];?>
     <td><?php $sql0=mysql_query("select tb_siswa.* from tb_siswa where tb_siswa.kode_kelas='$kode2'"); $cek=mysql_num_rows($sql0); if($cek>0){ ?>
	        <div class="btn-group">
	            <a href="?page=laporpelajaran&kelas=<?php echo $data['kode_kelas']; ?>&kompetensi=<?php echo $data['kompetensi_kode']; ?>"><button class='btn btn-mini btn-primary'> Daftar Nilai </button></a>&nbsp;&nbsp;
		...
		<td><?php if($cek>0){ ?><div class="btn-group">
	            <a href="?page=siswadet&kelas=<?php echo $data['kode_kelas']; ?>"><button class='btn btn-mini btn-success'> Nilai Detail </button></a>&nbsp;&nbsp;
